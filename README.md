...
The **Global Atlas of the Pan-Urban Virome** was constructed from over **12,000 metagenomes** spanning **280 cities across 86 countries or regions**.  
Our analysis cataloged **23,800 viral species**, over **94% of which were previously uncharacterized**.  
...
#### **1. Quality Control**
- [fastp](https://github.com/OpenGene/fastp) and [bowtie2](https://github.com/BenLangmead/bowtie2) were used to remove low-quality reads and trim adapter sequences.  
- Reads originating from the host (e.g., human reference genome) were filtered out.
